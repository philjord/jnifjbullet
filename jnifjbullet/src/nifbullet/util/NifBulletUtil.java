...
public abstract class NifBulletUtil {
	 ...
	 * @return
	 */
	public static RigidBody createStaticRigidBody(	bhkRigidBody bhkRigidBody, CollisionShape colShape,
													Object userPointer) {
	...
	public static RigidBody createStaticRigidBody(	hknpMaterial hknpMaterial, CollisionShape colShape,
													Object userPointer) {
		RigidBodyConstructionInfo rbInfo = new RigidBodyConstructionInfo(0, null, colShape);
	...
	/**
	 * I convenience method because the default constructor uses the "busted" empty matrix constructor for rotation
	...
	/**
	 * NOTE! scale does not get applied, that MUST be sent to the Body build
	 * @param t3d
	 * @return
	 */
	...
	/**
	 * Transformed in place note, scale will be 1.0
	 * @param in
	 * @return
	 */

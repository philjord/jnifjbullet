...
public abstract class hkxShapeToCollisionShape
{
	...
	public static CollisionShape processBhkShape(hknpShape hknpShape, HKXContents contents, boolean isDynamic, float scale)
	{
	...
	private static CollisionShape createCollisionShape(hknpShape hknpShape, HKXContents contents, boolean isDynamic, float scale)
	{
		if (hknpShape instanceof hknpCompressedMeshShape)
		{
			...
			if (hknpCompressedMeshShape.data > 0) {
				...
				return hkxCollisionToNifBullet.hknpCompressedMeshShape(hknpCompressedMeshShapeData, isDynamic, scale, nifVer);
			}

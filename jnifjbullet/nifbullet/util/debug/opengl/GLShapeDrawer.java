...
import static nifbullet.util.debug.opengl.IGL.GL_COLOR_MATERIAL;
import static nifbullet.util.debug.opengl.IGL.GL_LINES;
import static nifbullet.util.debug.opengl.IGL.GL_TRIANGLES;
...
public class GLShapeDrawer
{
	...
	*/
	...
	private static HashMap<ConvexShape, ShapeHull> shapeToHull = new HashMap<ConvexShape, ShapeHull>();
				...
				switch (shape.getShapeType())
				{
					...
					default:
					{
						if (shape.isConvex())
						{
							...
							ShapeHull hull = shapeToHull.get(convexShape);
							if (hull == null)
							{
								...
								shapeToHull.put(convexShape, hull);
							}

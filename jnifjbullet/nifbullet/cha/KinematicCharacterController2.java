...
public class KinematicCharacterController2 extends ActionInterface
{
	...
	protected void stepDown(CollisionWorld collisionWorld, float dt)
	{
		...
		cb.collisionFilterGroup = getGhostObject().getBroadphaseHandle().collisionFilterGroup;
		cb.collisionFilterMask = getGhostObject().getBroadphaseHandle().collisionFilterMask;
